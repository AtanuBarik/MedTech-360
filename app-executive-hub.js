...
function renderExecutiveHub(){
  ...
  $('pageContent').innerHTML=
    ...
    '<section class="section executive-assistant-section"><div class="section-head"><div><h2>Executive intelligence assistant</h2><p>Ask a business question using the lens of your team, information need and regional responsibility.</p></div><span class="assistant-evidence-badge">Public intelligence + PMR</span></div>'+
