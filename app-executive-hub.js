...
function renderExecutiveHub(){
  ...
  $('pageContent').innerHTML=
    ...
    '<section class="section executive-assistant-section exec-section-first"><div class="section-head"><div><h2>Executive intelligence assistant</h2><p>Ask a business question using the lens of your team, information need and regional responsibility.</p></div><span class="assistant-evidence-badge">Public intelligence + PMR</span></div>'+
    ...
    '<section class="section exec-section-first"><div class="section-head"><div><h2>Immediate attention</h2><p>Signals and project milestones most likely to require an executive decision, response or follow-up.</p></div><button class="daily-link-btn" onclick="navigate(\'industry\')">Open industry overview →</button></div>'+execAttentionCards()+'</section>'+
    '<section class="section"><div class="section-head"><div><h2>PMR action center</h2><p>Ongoing primary market research projects and the next actions expected from Evalueserve.</p></div><button class="daily-link-btn" onclick="navigate(\'pmr\')">Open PMR portfolio →</button></div>'+execPmrActions()+'</section>'+
    '<section class="section"><div class="grid-2"><div class="card"><div class="card-title"><h3>Industry trends & dynamics</h3><small>Priority themes shaping the domain</small></div>'+execTrendCards()+'</div><div class="card"><div class="card-title"><h3>Global & regional buzz</h3><small>Current themes and opportunity hotspots</small></div>'+execRegionalBuzz()+'</div></div></section>'+
    '<section class="section"><div class="section-head"><div><h2>Macroeconomic & external-factor watch</h2><p>Directional factors that could change demand, investment, access, pricing or customer behavior.</p></div></div><div class="card">'+execMacroTable()+'</div></section>'+
    '<section class="section"><div class="section-head"><div><h2>Customer signals</h2><p>High-level customer evidence synthesized from the assumed VOC, expert and survey research portfolio.</p></div></div>'+execCustomerSignals()+'</section>'+
    '<section class="section"><div class="section-head"><div><h2>Key public signals</h2><p>Recent company, regulatory, product, clinical and organizational developments already captured in MedTech 360.</p></div><button class="daily-link-btn" onclick="navigate(\'ci\',\'news-alerts\')">Open News & Alerts →</button></div><div class="card">'+execSignalFeed()+'</div></section>';
}