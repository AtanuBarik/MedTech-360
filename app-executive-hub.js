...
function renderExecutiveHub(){
  ...
  $('pageContent').innerHTML=
    ...
    '<section class="section"><div class="section-head visual-section-head"><div class="visual-title-wrap">'+execVisualIcon("pmr")+'<div><h2>PMR action center</h2><p>Ongoing primary market research projects and the next actions expected from Evalueserve.</p></div></div><button class="daily-link-btn" onclick="navigate(\'pmr\')">Open PMR portfolio →</button></div>'+execPmrActions()+'</section>'+
    ...
    '<section class="section"><div class="section-head visual-section-head"><div class="visual-title-wrap">'+execVisualIcon("customer")+'<div><h2>Customer signals</h2><p>High-level customer evidence synthesized from the assumed VOC, expert and survey research portfolio.</p></div></div></div>'+execCustomerSignals()+'</section>'+
